...
def import_dataset(df=r'C:\Users\carswje\OneDrive - HII\Documents\GitHub\Fleet-Sustainment-HVAC-Project\Archive\Modeling\dataset_ri.csv') -> pd.DataFrame:
    """
...
def update_graphs(ship, feature, view, point_size, start_date, end_date):
    ...
    if view == 'Front': # centerline x deck -------------------------------------------------------------
        ...
        image_source = Image.open(r'C:\Users\carswje\OneDrive - HII\Documents\GitHub\Fleet-Sustainment-HVAC-Project\Archive\Modeling\cvn69-front.png') # add background image
        ...
        image_source = Image.open(r'C:\Users\carswje\OneDrive - HII\Documents\GitHub\Fleet-Sustainment-HVAC-Project\Archive\Modeling\CVN68-side.png') # add background image
        ...
        image_source = Image.open(r'C:\Users\carswje\OneDrive - HII\Documents\GitHub\Fleet-Sustainment-HVAC-Project\Archive\Modeling\CVN68-top.png') # add background image
