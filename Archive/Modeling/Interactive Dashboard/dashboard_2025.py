...
def update_graphs(ship, feature, view, point_size, start_date, end_date):
    ...
    if view == 'Front': # centerline x deck -------------------------------------------------------------
        ...
        geo_scatter = px.scatter(dff, x='Centerline (Distance)', y='Deck', hover_data={'csmp_narrative_summary': True, 'job_status': True}, #HERE------------------------
        ...
        geo_scatter = px.scatter(dff, x='Frame', y='Deck', hover_data={'csmp_narrative_summary': True, 'job_status': True}, #HERE------------------------
        ...
        geo_scatter = px.scatter(dff, x='Frame', y='Centerline (Distance)', hover_data={'csmp_narrative_summary': True, 'job_status': True}, #HERE------------------------
