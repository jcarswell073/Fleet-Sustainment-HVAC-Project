####Contains errors. 
#Aims to add work_center to dashboard left side for filtering. Would be top 6 most common
# Currently, Type Error. 
# Add to controls and make appropriate change in update_graphs
# Logic: Follow feature-selections as reference
#mistake is in update-graphs. 
# added to control side. try to find out why this isn't working
...
workcenter_options = ['All Work Centers','ea03','ee02','pm01','cs83','vv40','ss40','ee03']
...
controls = dbc.Card([
        ...
        html.Div([ # work center selection
                dbc.Label("Work Center"),
                dcc.Dropdown(workcenter_options, 'All Work Centers',
                    id="workcenter-selection")]),
...
@app.callback(
    ...
    Input("workcenter-selection", "value"), 
...
def update_graphs(ship, workcenter, feature, view, point_size, start_date, end_date): ##Here
    ...
    if view == 'Front': # centerline x deck -------------------------------------------------------------
        ...
        geo_scatter = px.scatter(dff, x='Centerline (Distance)', y='Deck', hover_data={'csmp_narrative_summary': True, 'job_status': True},
        ...
        geo_scatter = px.scatter(dff, x='Frame', y='Deck', hover_data={'csmp_narrative_summary': True, 'job_status': True}, 
        ...
        geo_scatter = px.scatter(dff, x='Frame', y='Centerline (Distance)', hover_data={'csmp_narrative_summary': True, 'job_status': True}, 
